...
public class ServiceMeteoImp implements ServiceMeteo{
    ...
    public void saveDataInCsv(String maxTemperature, String minTemperature, String date) {
        try {
            File fileCSV = new File("/Users/mbouibourdonsafouemmanuelle/Desktop/Master2Données&SystèmesConnectés_21-22/semanticWeb/sementicWebKMPM_DSC/sementicWeb/src/main/java/ujmstudentproject/sementicweb/data");
